...
## Decision
Six enrichments were added to the base schema:
...
- All six additions are optional except `prerequisiteType`, preserving design flexibility during early authoring.
